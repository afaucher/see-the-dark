...
public class ColorPalate {
	...
	// returned
	public static final Color ACTIVE_SENSOR_HITS = new Color(0.93f, 0.87f,
			0.72f, 1.0f); // Yellow
	public static final Color PASSIVE_SENSOR_HITS = new Color(0.93f, 0.87f,
			0.72f, 0.5f); // Yellow
	// orange
	...
	public static final Color ACTIVE_HUD = new Color(0.67f, 0.84f, 0.90f, 1.0f); // Light
																					// Blue
	public static final Color INACTIVE_HUD = new Color(0.37f, 0.54f, 0.60f,
			1.0f); // Blue
	public static final Color HUD_BG = new Color(0.95f, 0.95f, 0.95f, 1); // Light
																			// Grey
	
	public static final Color WEAPON_RANGE= new Color(0.79f, 0.23f, 0.05f, 1.0f); // Redish Bround
	public static final Color WEAPON_AIMER= new Color(1.0f, 0.0f, 0.00f, 0.5f); // Transparent red
