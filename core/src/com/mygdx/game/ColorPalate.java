...
public class ColorPalate {
	public static final Color BACKGROUND = new Color(0.16f, 0.17f, 0.02f, 1.0f); //Near black
	public static final Color HITS = new Color(0.93f, 0.87f, 0.72f, 1.0f); //Yellow orange
